...
import com.plantStore.services.ClientService;
import com.plantStore.services.ProductService;
import com.plantStore.services.SaleService;
...
public class SalesTest {
    ...
    public void FullTest(){
        ...
        if (!productService.productExists(name)) {
            productService.addProduct(sPrice, count, name);
        }
        else {
